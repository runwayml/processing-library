...
void queryRunway(){
  ...
  // set style image
  input.setString("style",ModelUtils.toBase64(styleImage));
  // set content image
  input.setString("content",ModelUtils.toBase64(contentImage));
  // query Runway
